...
internal sealed class PasswordHasher : IPasswordHasher
{
    ...
    public string Hash(string password)
    {
        ...
        byte[] hash = Rfc2898DeriveBytes.Pbkdf2(password, salt, _options.Iterations, Algorithm, _options.HashSize);
    ...
    public bool Verify(string password, string passwordHash)
    {
        ...
        byte[] inputHash = Rfc2898DeriveBytes.Pbkdf2(password, salt, _options.Iterations, Algorithm, _options.HashSize);
